...
namespace TheLeftExit.Memory.NativeInterop {
	...
	internal unsafe class NativeMethods {
        ...
        [DefaultDllImportSearchPaths(DllImportSearchPath.System32)]
        public static extern bool ReadProcessMemory(HANDLE hProcess, void* lpBaseAddress, void* lpBuffer, nuint nSize, [Optional] nuint* lpNumberOfBytesRead);

        [DllImport("Kernel32", ExactSpelling = true, SetLastError = true)]
        [DefaultDllImportSearchPaths(DllImportSearchPath.System32)]
        public static extern unsafe bool WriteProcessMemory(HANDLE hProcess, void* lpBaseAddress, void* lpBuffer, nuint nSize, [Optional] nuint* lpNumberOfBytesWritten);

        [DllImport("Kernel32", ExactSpelling = true, SetLastError = true)]
        [DefaultDllImportSearchPaths(DllImportSearchPath.System32)]
        public static extern unsafe bool IsWow64Process(HANDLE hProcess, out bool Wow64Process);
	...
	// Structure that is identical to and interchangeable with IntPtr.
	// Used to prevent ambiguity in P/Invoke method signatures. Can be replaced with `using HANDLE = System.IntPtr`.
